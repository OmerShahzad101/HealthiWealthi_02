        ...
        <div className="appointments">
          <div className="appointment-list">
            <div className="profile-info-widget">
              <Link to="client-dashboard" className="booking-doc-img"><img src="/assets/img/patients/patient.jpg" alt="user" /></Link>
              <div className="profile-det-info">
                <h3> <Link to="client-dashboard">Richard Wilson</Link></h3>
            ...
            <div className="appointment-action">
              ...
              <a href="#;" className="btn btn-sm bg-success-light"><i className="fas fa-check"></i> Accept </a>
              <a href="#;" className="btn btn-sm bg-danger-light"><i className="fas fa-times"></i> Cancel</a>
            </div>
          </div>
        </div>
      </div>
