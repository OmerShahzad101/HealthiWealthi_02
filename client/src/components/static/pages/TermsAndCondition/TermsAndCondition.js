...
const TermsAndCondition = () => {
  return (
    <div>
      ...
      <p>Welcome to healthiwealthi.arhamsoft.org!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Healthi Wealthi's Website, located at
        https://healthiwealthi.arhamsoft.org/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use healthiwealthi.arhamsoft.org if you
      ...
      <p>
        We employ the use of cookies. By accessing healthiwealthi.arhamsoft.org,
        you agreed to use cookies in agreement with the Healthi Wealthi's
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Healthi Wealthi and/or its licensors own the
        intellectual property rights for all material on
        healthiwealthi.arhamsoft.org. All intellectual property rights are
        reserved. You may access this from healthiwealthi.arhamsoft.org for your
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from healthiwealthi.arhamsoft.org</li>
        <li>
          Sell, rent or sub-license material from healthiwealthi.arhamsoft.org
        </li>
        <li>
          Reproduce, duplicate or copy material from
          healthiwealthi.arhamsoft.org
        </li>
        <li>Redistribute content from healthiwealthi.arhamsoft.org</li>
      </ul>
      ...
      <p>
        ...
        Healthi Wealthi does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Healthi Wealthi,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Healthi Wealthi
      ...
      <p>
        Healthi Wealthi reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Healthi Wealthi a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Healthi Wealthi; and (d) the
      ...
      <p>
        ...
        e-mail to Healthi Wealthi. Please include your name, your organization
      ...
      <p>
        No use of Healthi Wealthi's logo or other artwork will be allowed for
