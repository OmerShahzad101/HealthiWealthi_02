            ...
            <div className="col-lg-5 col-md-7 text-center">
              <div className="account-content login-right">
                ...
                <Form noValidate onSubmit={changePasswordHandler}>
                  <FloatingLabel controlId="floating-input-new-password" label="Password"className="mb-3">
                  ...
                  <FloatingLabel controlId="floating-input-confirm-password" label="Confirm New Password"className="mb-3">
